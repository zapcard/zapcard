...
unlocked to sign the Zapcard-Qt.app bundle.
...
allowing somebody to distribute a Zapcard-Qt.app or zapcard-qt-setup.exe with a valid
...
that the zapcard-qt.exe file inside the installer had not been tampered with.
