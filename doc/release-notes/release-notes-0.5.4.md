Zapcard version 0.5.4 is now available for download at:
http://sourceforge.net/projects/zapcard/files/Zapcard/zapcard-0.5.4/
...
http://gitorious.org/zapcard/zapcardd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Zapcard-Qt notifications under Growl 1.3.
Increase required age of Zapcard-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxZapcard properly when installing Zapcard-Qt over it. (Windows)
