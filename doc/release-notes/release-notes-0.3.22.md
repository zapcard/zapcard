Download URL: https://sourceforge.net/projects/zapcard/files/Zapcard/zapcard-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ZAP fee schedule (users still pay 0.01 ZAP per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #zapcard00 - #zapcard99
