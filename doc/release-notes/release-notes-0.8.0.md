Zapcard-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/zapcard/files/Zapcard/zapcard-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Zapcard
...
New/changed settings (command-line or zapcard.conf file)
--------------------------------------------------------
