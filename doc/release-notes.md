Zapcard Core version 0.9.4 is now available from:

  https://zapcard.org/bin/0.9.4/
...
installer (on Windows) or just copy over /Applications/Zapcard-Qt (on Mac) or
zapcardd/zapcard-qt (on Linux).
...
this update is incompatible with the Zapcard system and could lead to consensus
forks.

Zapcard Core released binaries from https://zapcard.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~zapcard/+archive/ubuntu/zapcard
- A third-party or self-compiled Zapcard Core

upgrade to Zapcard Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/zapcard/).
