...
unsigned int pnSeed[] =
{
 /* 0x7e6a692e, 0x7d04d1a2, 0x6c0c17d9, 0xdb330ab9, 0xc649c7c6, 0x7895484d, 0x047109b0, 0xb90ca5bc,
    ...
    0xc15ebb6a, 0x2c08c452, 0xc7fd0652, 0x7604f8ce, 0xffb39332, 0xa4c2efd5, 0xe9614018, 0xab49e557,
...
public:
    CMainParams() {
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks"; //"Zapcard the future";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        vSeeds.push_back(CDNSSeedData("zapcard.org", "seed.zapcard.org"));
        vSeeds.push_back(CDNSSeedData("zapcard.org", "seed1.zapcard.org"));
        vSeeds.push_back(CDNSSeedData("zapcard.org", "seed2.zapcard.org"));
        vSeeds.push_back(CDNSSeedData("zapcard.org", "seed3.zapcard.org"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("zapcard.org", "testnet.zapcard.org"));
