...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/zapcard"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Zapcard"),
     ...
     * override -datadir in the zapcard.conf file in the default data directory
     * (to be consistent with zapcardd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
