...
#include "zapcard-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatZapcardURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + ZapcardUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatZapcardURI(info));
}
